# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 15:05:15 2019
...
class JDPhone(object):
    def __init__(self, max_p):
        ...
        self.set_title()
        self.driver = webdriver.PhantomJS(executable_path=r"D:\soft\phantomjs-2.1.1-windows\bin\phantomjs.exe")
    ...
    def save_info(self, *args):
        ...
        print(url)
        html = requests.get(url, headers=self.headers, proxies=proxies).text
